...
SET @POLY2= geography::STGeomFromText('POLYGON((
-80.5196 40.8531
, -80.5195 40.4769
, -80.3591 40.4768
, -79.8306 40.1493
...
, -80.1480 40.6743
, -80.1566 40.8544
, -80.5196 40.8531))', 4326) --Western PA Permit Counties - Beaver, Allegheny
...
SELECT 
	...
	,[WithinWestPA] = geography::Point(ISNULL(((CONVERT(decimal,(trc_gps_latitude))/60)/60),0),
...
write.table(Filtered_TractorLocation, 
            file="C:/Users/SullivanRy/Documents/SpottedLaternFly_TractorLocations.csv", 
            row.names=F,
            col.names=T,
            sep=",",
            append=FALSE)
...
ORDER BY 1")
  ...
  htmlwidgets::saveWidget(trcmap, file = "C:/Users/SullivanRy/Documents/SpottedLaternFly_TractorLocations.html")
  
  ###Read in the pings data 
  TrcPings <- read.csv("SpottedLaternFly_TractorLocations.csv",header=TRUE)
  ...
  htmlwidgets::saveWidget(trclines, file = "C:/Users/SullivanRy/Documents/SpottedLaternFly_TractorLocationsLines.html")
