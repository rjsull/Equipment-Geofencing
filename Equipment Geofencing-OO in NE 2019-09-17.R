...
write.table(Filtered_TractorLocation, 
            file="C:/Users/SullivanRy/Documents/NEOO_TractorLocations.csv", 
            row.names=F,
            col.names=T,
            sep=",",
            append=FALSE)
...
ORDER BY 1")
  ...
  htmlwidgets::saveWidget(trcmap, file = "C:/Users/SullivanRy/Documents/NEOO_TractorLocations.html")
  ###Read in the pings data 
  TrcPings <- read.csv("NEOO_TractorLocations.csv",header=TRUE)
  ...
  htmlwidgets::saveWidget(trclines, file = "C:/Users/SullivanRy/Documents/NEOO_TractorLocationsLines.html")
